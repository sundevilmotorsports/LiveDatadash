CREATE TABLE imu(id INTEGER NOT NULL PRIMARY KEY, timestamp INTEGER NOT NULL, 
...
CREATE TABLE wheel(id INTEGER NOT NULL PRIMARY KEY, timestamp INTEGER NOT NULL, 
...
CREATE TABLE datalog(id INTEGER NOT NULL PRIMARY KEY, timestamp INTEGER NOT NULL,
...
CREATE TABLE ack(id INTEGER NOT NULL PRIMARY KEY, timestamp INTEGER NOT NULL);